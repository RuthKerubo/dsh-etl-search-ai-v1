      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16 items-center">
          ...
          <div class="flex items-center gap-6">
            <RouterLink to="/" class="flex items-center gap-2 text-emerald-900 font-bold text-lg shrink-0">
              <!-- Leaf icon -->
            ...
            <div class="hidden sm:flex items-center gap-5">
              <RouterLink to="/" class="text-sm font-medium text-gray-500 hover:text-emerald-700 transition-colors"
                active-class="text-green-600">Search</RouterLink>
              <RouterLink v-if="auth.isLoggedIn" to="/chat"
                class="text-sm font-medium text-gray-500 hover:text-emerald-700 transition-colors"
                active-class="text-green-600">Chat</RouterLink>
              <RouterLink to="/about"
                class="text-sm font-medium text-gray-500 hover:text-emerald-700 transition-colors"
                active-class="text-green-600">About</RouterLink>
              <RouterLink v-if="auth.isAdmin" to="/admin"
                class="text-sm font-medium text-gray-500 hover:text-emerald-700 transition-colors"
                active-class="text-green-600">Admin</RouterLink>
            </div>
          </div>
